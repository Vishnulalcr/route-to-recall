...
export const metadata: Metadata = {
  title: "Travel Destinations - Explore Asia & Beyond",
  description: "Explore our handpicked travel destinations across Asia - Thailand, Singapore, Malaysia, Maldives, Bali, Sri Lanka, Nepal, Dubai & Cambodia. Customized tour packages starting from Rs.22,000. Find your next unforgettable journey with Route to Recall.",
  keywords: [
    "travel destinations",
    "Asia tour packages",
    "Thailand tour",
  ...
  openGraph: {
    title: "Travel Destinations | Route to Recall",
    description: "Explore our handpicked travel destinations across Asia for your next unforgettable journey. Customized tour packages available.",
    url: "https://routetorecall.com/destinations",
  },
  alternates: {

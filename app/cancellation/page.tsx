        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#1C1C1C] leading-relaxed">
                If we cancel a trip due to insufficient bookings or operational reasons on our part, you will receive a
                full refund or the option to transfer to another trip at no additional cost.
              </p>
            </div>

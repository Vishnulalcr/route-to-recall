...
export const metadata: Metadata = {
  title: "Contact Us - Plan Your Dream Vacation",
  description: "Get in touch with Route to Recall for personalized travel planning. Request a quote, ask questions, or book your next adventure. Located in Ernakulam, Kerala. Call +91 6363 331 334 or email enquiries@routetorecall.com.",
  keywords: [
    "contact travel agency",
    "travel inquiry",
    "book tour package",
    "travel consultation",
    "Route to Recall contact",
    "Kerala travel agency",
    "travel agent Ernakulam",
  ],
  openGraph: {
    title: "Contact Route to Recall | Plan Your Dream Vacation",
    description: "Get in touch with Route to Recall for personalized travel planning and custom tour packages.",
    url: "https://routetorecall.com/contact",
  },
  alternates: {
...
export default function ContactPage() {
  const breadcrumbItems = [
    ...
    { name: "Contact Us", url: "https://routetorecall.com/contact" },
  ]
  return (
    <>
      <BreadcrumbJsonLd items={breadcrumbItems} />
      <LocalBusinessJsonLd pagePath="/contact" />

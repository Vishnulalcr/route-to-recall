...
export default function FAQContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header */}
      <header className="relative h-[40vh] md:h-[50vh] flex items-center justify-center bg-gradient-to-br from-[#A259FF]/10 via-[#00C2FF]/10 to-[#39FF14]/10 overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 md:py-24">
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-[#A259FF]">Office Address</h2>
          <address className="text-[#666666] leading-relaxed not-italic">

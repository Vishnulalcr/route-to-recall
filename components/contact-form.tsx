...
export default function ContactForm() {
  ...
  if (submitStatus?.type === 'success') {
    return (
      <motion.div
        className="bg-accent/10 border border-accent rounded-2xl p-8 text-center"
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Button
        ...
        className="w-full rounded-full bg-accent hover:bg-primary text-accent-foreground hover:text-primary-foreground font-bold py-6 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
